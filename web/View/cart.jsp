...
<html>
    ...
    <body>
        ...
        <a href="<%= request.getContextPath() %>/home" style="display: inline-block; padding: 10px 20px; font-size: 18px; color: #fff; background-color: #007bff; border: none; border-radius: 5px; text-decoration: none; transition: background-color 0.3s ease;">Continue Shopping ?</a>
    </div>
        <h1>Cart</h1>
